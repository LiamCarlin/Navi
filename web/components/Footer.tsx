...
export function Footer() {
  return (
    <footer className="border-t border-line px-6 py-16">
      ...
      <div className="mx-auto mt-12 flex max-w-7xl flex-col gap-2 border-t border-line pt-6 text-[13px] text-fg-dim sm:flex-row sm:items-center sm:justify-between">
