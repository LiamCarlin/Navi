    ...
    <footer className="border-t border-line px-4 py-12 sm:px-6">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 text-sm text-fg-dim sm:flex-row">
        ...
        <nav className="flex items-center gap-6" aria-label="Legal">
          <a href="/privacy" className="transition-colors duration-200 hover:text-fg">
            Privacy
          </a>
          <a href="/terms" className="transition-colors duration-200 hover:text-fg">
            Terms
          </a>
          <a href="mailto:hello@navi.app" className="transition-colors duration-200 hover:text-fg">
            Contact
          </a>
        </nav>
      </div>
