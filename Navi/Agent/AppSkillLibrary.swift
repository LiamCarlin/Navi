    ...
    static let native: [AppSkill] = [
        ...
        AppSkill(
            ...
            howItWorks: [
                ...
                "Typing a name in 'To:' shows contact suggestions ~0.5 s later; Navi picks the matching contact itself right after the TYPE_TEXT (a blue pill appears and that person's thread opens). The step log says 'picked the contact …' — then the message field gets the text.",
            ...
            shortcuts: ["cmd+n": "New message (blank conversation, To: field focused)", "cmd+f": "Search conversations",
                        "return": "In the message field: SEND", "shift+return": "New line without sending"],
            recipes: [
                .init(goal: "send a message / text to a person", keywords: ["send", "text", "message", "imessage", "tell", "let", "reply", "say", "shoot", "ping", "know"],
                      steps: ["If the open conversation is not with that person: KEY cmd+n",
                              "TYPE_TEXT the person's name into the 'To:' field (Navi then picks their contact from the suggestions)",
            ...
            avoid: ["Do not click an existing conversation to message a DIFFERENT person — use ⌘N.",
                    ...
                    "Do not press Return in To: after Navi picked the contact — the recipient is already set.",
        ...
        AppSkill(
            ...
            howItWorks: [
                ...
                "In To:, typing a name shows suggestions; Navi picks the matching one itself right after the TYPE_TEXT (the step log says 'picked the contact …').",
        ...
        AppSkill(
            ...
            recipes: [
                ...
                .init(goal: "send an email", keywords: ["send", "email", "mail", "write", "compose"],
                      steps: ["KEY cmd+1 to switch to Mail", "KEY cmd+n", "TYPE_TEXT the recipient into To (Navi picks the suggested contact)", "CLICK Subject and TYPE_TEXT the subject", "CLICK the body and TYPE_TEXT it", "KEY cmd+return to send"]),
        ...
        AppSkill(
            ...
            howItWorks: ["'New FaceTime' button opens a sheet with a 'To:' field; type a name and Navi picks the contact from the suggestions, then the green 'FaceTime' (video) or 'Audio' button starts the call.",
            ...
            recipes: [
                .init(goal: "call someone", keywords: ["call", "facetime", "ring", "video", "phone"],
                      steps: ["KEY cmd+n", "TYPE_TEXT the person's name into To: (Navi picks the contact)", "CLICK the 'FaceTime' (video) or 'Audio' button"]),
            ],
